...
import { showJoinedMessage, downloadImageData, createMicrophoneAudioTrack, createCameraVideoTrack } from "@/utils/utils";
  ...
  */
  ...
  return <div className="padding-20">
    ...
    <Responsive style={{
      ...
      <Button type="primary" onClick={takeScreenshot} disabled={!joined} className="responsive-ml">Take Screenshot of local video track</Button>
    </Responsive>
