...
function BasicMuteSetEnabled() {
  ...
  */
  ...
  const muteAudio = async () => {
    await audioTrack.setEnabled(audioTrackMuted);
    setAudioTrackMuted(!audioTrackMuted);
  };
  const muteVideo = async () => {
    await videoTrack.setEnabled(videoTrackMuted);
  ...
  return <div className="padding-20">
    ...
    <Space style={{
      ...
      <Button type="primary" onClick={muteAudio} disabled={!joined}>{audioTrackMuted ? "Unmute Audio With SetEnabled" : "Mute Audio With SetEnabled"}</Button>
      <Button type="primary" onClick={muteVideo} disabled={!joined}>{videoTrackMuted ? "Unmute Video With SetEnabled" : "Mute Video With SetEnabled"}</Button>
    </Space>
...
export default BasicMuteSetEnabled;