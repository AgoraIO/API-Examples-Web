 ...
 */
  ...
  return <div className="padding-20">
    ...
    <Space style={{ marginTop: "10px" }}>
      ...
      <Button type="primary" onClick={openBeauty} disabled={!joined || beautyOpen}>Enable Beauty</Button>
      <Button type="primary" onClick={closeBeauty} disabled={!joined || !beautyOpen}>Disable Beauty</Button>
    </Space>
...
export default VideoBeautyEffect
