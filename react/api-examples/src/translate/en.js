export const en = {
  ...
  stt: 'Realtime transcriptioin',
  sttNote: 'Convert the speech in the RTC channel into text and broadcast it to the channel.',
  ...
  videoCompositor: "Video Compositor",
  videoCompositorNote: "WebSDK extension which combines local videos, images and screen sharing to one video stream.",
  tryitnow: 'Try it now',
