...
const NetworkTestDialog = forwardRef((props, ref) => {
  ...
  return <Modal title={title} open={open} footer={null} onCancel={() => setOpen(false)}>
    ...
    <Title level={5} style={{ marginTop: "0.5em" }}>Local Audio Stats</Title>
    <div>{localAudioStats}</div>
    <Title level={5} style={{ marginTop: "0.5em" }}>Local Video Stats</Title>
    <div>{localVideoStats}</div>
    <Title level={5} style={{ marginTop: "0.5em" }}>Downlink</Title>
    <div >Network Quality: {downlinkNetworkQuality}</div>
    <Title level={5} style={{ marginTop: "0.5em" }}>Remote Audio Stats</Title>
    <div>{remoteAudioStats}</div>
    <Title level={5} style={{ marginTop: "0.5em" }}>Remote Video Stats</Title>
