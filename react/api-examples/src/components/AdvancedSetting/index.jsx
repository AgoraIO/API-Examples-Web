...
const Codec = ({ onCodecChange, defaultValue = 'vp8' }) => {
...
const AdvancedSettings = ({
  ...
  return <Dropdown menu={{ items, selectable: false }} placement="bottom">
    <Button type="primary" style={{ width: "400px" }}>ADVANCED SETTINGS</Button>
  </Dropdown>
