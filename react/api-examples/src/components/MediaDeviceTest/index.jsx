...
const MediaDeviceTest = forwardRef((props, ref) => {
  ...
  >
    ...
    <Progress percent={volume} status="active" showInfo={false} style={{ marginTop: "10px", marginBottom: "10px" }} />
    <CameraSelect videoTrack={videoTrack}></CameraSelect>
    <AgoraVideoPlayer style={{ marginTop: "10px" }} audioTrack={audioTrack} videoTrack={videoTrack} width={"240px"} height={"180px"}></AgoraVideoPlayer>
  </Modal>
